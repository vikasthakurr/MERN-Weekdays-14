...
const student1 = {
  ...
  introduce: function(hobby, favoriteSubject) {
    console.log(`Hi, I am ${this.name}! I love ${hobby} and my favorite subject is ${favoriteSubject}.`);
  }
};
...
const priyaIntroForLater = student1.introduce.bind(student2, "coding", "Computers");
